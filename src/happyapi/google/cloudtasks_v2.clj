...
PurgeQueueRequest"
  ...
  {:method :post,
   :uri-template "https://cloudtasks.googleapis.com/v2/{+name}:purge",
   :uri-template-args {"name" name},
   :query-params {},
   :scopes ["https://www.googleapis.com/auth/cloud-platform"],
...
PauseQueueRequest"
  ...
  {:method :post,
   :uri-template "https://cloudtasks.googleapis.com/v2/{+name}:pause",
   :uri-template-args {"name" name},
   :query-params {},
   :scopes ["https://www.googleapis.com/auth/cloud-platform"],
...
ResumeQueueRequest"
  ...
  {:method :post,
   :uri-template "https://cloudtasks.googleapis.com/v2/{+name}:resume",
   :uri-template-args {"name" name},
   :query-params {},
   :scopes ["https://www.googleapis.com/auth/cloud-platform"],
