...
https://developers.google.com/custom-search/v1/introduction/v1/reference/rest/v1/cse/list
...
enableAlternateSearchHandler <boolean> Optional. Enables routing of Programmable Search Engine requests to an alternate search handler.
...
https://developers.google.com/custom-search/v1/introduction/v1/reference/rest/v1/cse/siterestrict/list
