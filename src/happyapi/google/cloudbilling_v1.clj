...
https://cloud.google.com/billing/docs/apis/v1/reference/rest/v1/billingAccounts/get
...
https://cloud.google.com/billing/docs/apis/v1/reference/rest/v1/billingAccounts/list
...
https://cloud.google.com/billing/docs/apis/v1/reference/rest/v1/billingAccounts/patch
...
https://cloud.google.com/billing/docs/apis/v1/reference/rest/v1/billingAccounts/create
...
https://cloud.google.com/billing/docs/apis/v1/reference/rest/v1/billingAccounts/getIamPolicy
...
https://cloud.google.com/billing/docs/apis/v1/reference/rest/v1/billingAccounts/setIamPolicy
...
https://cloud.google.com/billing/docs/apis/v1/reference/rest/v1/billingAccounts/testIamPermissions
...
https://cloud.google.com/billing/docs/apis/v1/reference/rest/v1/billingAccounts/move
...
(defn billingAccounts-subAccounts-list
  "Lists the billing accounts that the current authenticated user has permission to [view](https://cloud.google.com/billing/docs/how-to/billing-access).
https://cloud.google.com/billing/docs/apis/v1/reference/rest/v1/billingAccounts/subAccounts/list
...
(defn billingAccounts-subAccounts-create
  "This method creates [billing subaccounts](https://cloud.google.com/billing/docs/concepts#subaccounts). Google Cloud resellers should use the Channel Services APIs, [accounts.customers.create](https://cloud.google.com/channel/docs/reference/rest/v1/accounts.customers/create) and [accounts.customers.entitlements.create](https://cloud.google.com/channel/docs/reference/rest/v1/accounts.customers.entitlements/create). When creating a subaccount, the current authenticated user must have the `billing.accounts.update` IAM permission on the parent account, which is typically given to billing account [administrators](https://cloud.google.com/billing/docs/how-to/billing-access). This method will return an error if the parent account has not been provisioned for subaccounts.
https://cloud.google.com/billing/docs/apis/v1/reference/rest/v1/billingAccounts/subAccounts/create
...
https://cloud.google.com/billing/docs/apis/v1/reference/rest/v1/billingAccounts/projects/list
...
(defn organizations-billingAccounts-list
  "Lists the billing accounts that the current authenticated user has permission to [view](https://cloud.google.com/billing/docs/how-to/billing-access).
https://cloud.google.com/billing/docs/apis/v1/reference/rest/v1/organizations/billingAccounts/list
...
(defn organizations-billingAccounts-create
  "This method creates [billing subaccounts](https://cloud.google.com/billing/docs/concepts#subaccounts). Google Cloud resellers should use the Channel Services APIs, [accounts.customers.create](https://cloud.google.com/channel/docs/reference/rest/v1/accounts.customers/create) and [accounts.customers.entitlements.create](https://cloud.google.com/channel/docs/reference/rest/v1/accounts.customers.entitlements/create). When creating a subaccount, the current authenticated user must have the `billing.accounts.update` IAM permission on the parent account, which is typically given to billing account [administrators](https://cloud.google.com/billing/docs/how-to/billing-access). This method will return an error if the parent account has not been provisioned for subaccounts.
https://cloud.google.com/billing/docs/apis/v1/reference/rest/v1/organizations/billingAccounts/create
...
(defn organizations-billingAccounts-move
  "Changes which parent organization a billing account belongs to.
https://cloud.google.com/billing/docs/apis/v1/reference/rest/v1/organizations/billingAccounts/move
...
https://cloud.google.com/billing/docs/apis/v1/reference/rest/v1/projects/getBillingInfo
...
https://cloud.google.com/billing/docs/apis/v1/reference/rest/v1/projects/updateBillingInfo
...
https://cloud.google.com/billing/docs/apis/v1/reference/rest/v1/services/list
...
https://cloud.google.com/billing/docs/apis/v1/reference/rest/v1/services/skus/list
