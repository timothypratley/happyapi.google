...
CancelOperationRequest"
  ...
  {:method :post,
   :uri-template "https://notebooks.googleapis.com/v2/{+name}:cancel",
   :uri-template-args {"name" name},
   :query-params {},
   :scopes ["https://www.googleapis.com/auth/cloud-platform"],
...
UpgradeInstanceRequest"
  ...
  {:method :post,
   :uri-template "https://notebooks.googleapis.com/v2/{+name}:upgrade",
   :uri-template-args {"name" name},
   :query-params {},
   :scopes ["https://www.googleapis.com/auth/cloud-platform"],
...
RestoreInstanceRequest"
  ...
  {:method :post,
   :uri-template "https://notebooks.googleapis.com/v2/{+name}:restore",
   :uri-template-args {"name" name},
   :query-params {},
   :scopes ["https://www.googleapis.com/auth/cloud-platform"],
